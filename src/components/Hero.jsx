...
const Hero = () => {
  return (
    <div name='hero' className='w-full h-screen bg-[#0a192f] flex'>
        <div className='ml-5 my-auto flex-col invisible sm:visible'>
        ...
        {/* Container */}
        <div className='max-w-[1000px] mx-auto px-10 flex flex-col justify-center h-full place-items-center text-center'>
        ...
        <div className='mr-5 my-auto flex-col items-center invisible sm:visible'>
          <img className='w-5 pb-1' alt='Github' src={Name_Logo}/>
          <img className='w-5 py-1' alt='LinkedIn' src={Name_Logo}/>
          <img className='w-5 pt-1' alt='Behance' src={Name_Logo}/>
        </div>
