...
const Hero = () => {
  return (
    <motion.div variants={main} initial="hidden" animate="show" name='hero' className='w-full h-screen bg-background flex'>
        {/* Left Socials */}
        <motion.div variants={left} className='ml-10 my-auto flex-col invisible sm:visible'>
            <a href="https://github.com/Kabiirk" target="_blank" rel="noopener noreferrer" aria-label="Github">
                <svg className='w-5 pb-2 fill-subheading hover:fill-heading hover:duration-200' 
            ...
            <a href="https://www.linkedin.com/in/kabiir-krishna-21a6a516b/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <svg className='w-5 py-2 fill-subheading hover:fill-heading hover:duration-200' 
            ...
            <a href="https://www.behance.net/kabiirk" target="_blank" rel="noopener noreferrer" aria-label="Behance">
                <svg className='w-5 pt-2 fill-subheading hover:fill-heading hover:duration-200' 
