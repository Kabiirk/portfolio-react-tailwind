    ...
    <div name='hero' className='w-full h-screen bg-background flex'>
        ...
        <motion.div className='ml-10 my-auto flex-col invisible sm:visible'
            ...
            <a href="https://github.com/Kabiirk" target="_blank" rel="noopener noreferrer">
                <motion.svg variants={variantleftsocial} className='w-5 pb-2 fill-subheading hover:fill-heading hover:duration-200' 
            ...
            <a href="https://www.linkedin.com/in/kabiir-krishna-21a6a516b/" target="_blank" rel="noopener noreferrer">
                <motion.svg variants={variantleftsocial} className='w-5 py-2 fill-subheading hover:fill-heading hover:duration-200' 
            ...
            <a href="https://www.behance.net/kabiirk" target="_blank" rel="noopener noreferrer">
                <motion.svg variants={variantleftsocial} className='w-5 pt-2 fill-subheading hover:fill-heading hover:duration-200' 
        ...
        {/* Right Email */}
        <motion.div className='mr-10 my-auto flex-col invisible sm:visible write-mode-vertical text-subheading hover:text-heading hover:duration-200'
                    variants={variantrightsocial}
                    initial="hidden"
                    animate="show">
