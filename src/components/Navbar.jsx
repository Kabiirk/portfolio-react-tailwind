  ...
  return (
    <div className='fixed w-full h-15 flex justify-between items-center px-10 bg-[#0a192f] text-gray-300'>
        ...
        <ul className={!nav ? 'hidden' : 'absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col justify-center items-center'}>
            <li className='flex py-3 text-2xl font-sf-mono-sb'><h1 className='text-cyan-400'>01.</h1>About</li>
            <li className='flex py-3 text-2xl font-sf-mono-sb'><h1 className='text-cyan-400'>02.</h1>Skills & Tools</li>
            <li className='flex py-3 text-2xl font-sf-mono-sb'><h1 className='text-cyan-400'>03.</h1>Experience</li>
            <li className='flex py-3 text-2xl font-sf-mono-sb'><h1 className='text-cyan-400'>04.</h1>Projects</li>
            <li className='flex py-3 text-2xl font-sf-mono-sb'><h1 className='text-cyan-400'>05.</h1>Contacts</li>
